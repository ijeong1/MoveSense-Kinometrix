...
import com.kinometrix.app.api.logs.LogsListAdapter;
...
public class SendLogsToGoogleDriveActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,
    ...
    private final String MOVESENSE_DIRECTORY_GOOGLEDRIVE_NAME = "KinometrixLog";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Query logs from Kinometrix folder
        queryLogsFile();
    ...
    private void queryLogsFile() {
        ...
        File dirFile = new File(externalDirectory + "/Kinometrix");
        if (dirFile.exists()) {
            ...
            Log.e(LOG_TAG, "Kinometrix logs dir not exists.");
